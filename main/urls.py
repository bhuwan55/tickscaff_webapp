...
from .views import Login,NewAddJobs, index, AddGear, ViewGear, JobDetail, AddJobs, AddGearNumber, ViewJobs, AddReturned, ViewReturned, EditGear, DeleteGear, EditJobs, DeleteJobs
...
urlpatterns = [
    ...
    path('job/details/<int:id>', JobDetail, name="job_detail"),
